...
### Hint: the Hyperspectral image file for this code is too large (~26 Mb) to be uploaded on Github. For this code to work you need to download the "Salinas.mat" file from [here](http://www.ehu.eus/ccwintco/uploads/f/f1/Salinas.mat) and put it insde the Data folder.  
